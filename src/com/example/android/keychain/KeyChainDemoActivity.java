...
public class KeyChainDemoActivity extends Activity implements
    ...
    // Test SSL URL
    private static final String TEST_SSL_URL = "http://localhost:8080";
    ...
    public void log(String text) {
    	...
    	runOnUiThread(new Runnable() {
             ...
             public void run() {
    		     ...
    		     TextView debugTv = (TextView) findViewById(R.id.log_text);
    ...
    private void bindStepService() {
        if (!bindService(new Intent(this, 
        		SecureWebServerService.class), mConnection, Context.BIND_AUTO_CREATE + Context.BIND_DEBUG_UNBIND)) {
    ...
    private SecureWebServerService mService;
    private ServiceConnection mConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName className, IBinder service) {
            ...
            mService = ((SecureWebServerService.StepBinder)service).getService();

            mService.registerCallback(mCallback);
            log("bound callback");
            
            ((SecureWebServerService.StepBinder)service).testStep();
    ...
    private SecureWebServerService.ICallback mCallback = new SecureWebServerService.ICallback() {
